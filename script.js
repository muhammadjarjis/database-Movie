...
//   $.ajax({
//     url: "http://www.omdbapi.com/?apikey=5efd4f6d&s=" + $(".input-keyword").val(),
//     success: (result) => {
...
//         $.ajax({
//           url: "http://www.omdbapi.com/?apikey=5efd4f6d&i=" + $(this).data("imdbid"),
//           success: (m) => {
...
//   fetch("http://www.omdbapi.com/?apikey=5efd4f6d&s=" + inputKeyword.value)
...
//           fetch("http://www.omdbapi.com/?apikey=5efd4f6d&i=" + imdbid)
//             .then((response) => response.json())
//             .then((m) => {
//               const movieDetail = showMovieDetail(m);
    ...
    <div class="row">
      ...
      <div class="col-md">
        <ul class="list-group">
          ...
          <li class="list-group-item"><strong>Languages :</strong>${m.Language}</li>
